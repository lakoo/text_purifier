...
namespace TestUtil
{
    ...
    void testEmpty(const lakoo::TextPurifier& tp)
    {
        ...
        CPPUNIT_ASSERT_EQUAL(false, tp.check(STRING(_Type, "歧視甲")));
        CPPUNIT_ASSERT_EQUAL(false, tp.check(STRING(_Type, "歧視乙")));
        CPPUNIT_ASSERT_EQUAL(false, tp.check(STRING(_Type, "歧視丙")));
        CPPUNIT_ASSERT_EQUAL(false, tp.check(STRING(_Type, "歧視甲乙丙")));
    ...
    {
        CPPUNIT_ASSERT_EQUAL(false, tp.check(STRING(_Type, "")));
        CPPUNIT_ASSERT_EQUAL(false, tp.check(STRING(_Type, "歧視")));
        ...
        CPPUNIT_ASSERT_EQUAL(false, tp.check(STRING(_Type, "歧視粗口色情")));
        CPPUNIT_ASSERT_EQUAL(false, tp.check(STRING(_Type, "甲乙丙")));
        CPPUNIT_ASSERT_EQUAL(true, tp.check(STRING(_Type, "歧視甲")));
        CPPUNIT_ASSERT_EQUAL(true, tp.check(STRING(_Type, "歧視乙")));
        CPPUNIT_ASSERT_EQUAL(true, tp.check(STRING(_Type, "歧視丙")));
        CPPUNIT_ASSERT_EQUAL(true, tp.check(STRING(_Type, "歧視甲乙丙")));
